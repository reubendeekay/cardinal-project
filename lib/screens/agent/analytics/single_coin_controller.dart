    ...
    return <ChartSeries<SplineAreaData, double>>[
      SplineAreaSeries<SplineAreaData, double>(
        ...
        gradient: LinearGradient(
          colors: [
            AppTheme.estateTheme.colorScheme.primary.withAlpha(100),
            AppTheme.estateTheme.colorScheme.primary.withAlpha(60),
            AppTheme.estateTheme.colorScheme.primary.withAlpha(40),
            AppTheme.estateTheme.colorScheme.primary.withAlpha(20),
            AppTheme.estateTheme.colorScheme.primary.withAlpha(0),
          ],
